...
var ComplexAlgebraic = /** @class */ (function (_super) {
    ...
    ComplexAlgebraic.prototype.polar = function () {
        ...
        var phi = Math.atan2(this.b, this.a);
        return new ComplexPolar(rad, phi);
    };
    ComplexAlgebraic.prototype.re = function () {
        return this.a;
    };
    ComplexAlgebraic.prototype.im = function () {
        return this.b;
    };
...
var ComplexPolar = /** @class */ (function (_super) {
    ...
    ComplexPolar.prototype.rad = function () {
        return this.a;
    };
    ComplexPolar.prototype.phi = function () {
        return this.b;
    };
    return ComplexPolar;
}(ComplexNumber));
